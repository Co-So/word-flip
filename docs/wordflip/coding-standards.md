...
| **术语** | 与产品文档一致：稳定性 S / 热力档、队列三态（未学习/模糊/不认识）、增量追加、wordKey、艾宾浩斯/SRS；词库：**sense / primary / quality(ok|uncertain|reject)**、释义真相=`dict_senses` |
...
| 2026-07-10 | v1.1 | 补充词库术语：sense / primary / quality；释义真相 dict_senses |
